...
ggmap(eniMap) + stat_summary_2d(geom = "tile",bins = 35, data=race, aes(x = long, y = lat, z = eni), alpha=0.5) +
scale_fill_gradient(low = "green", high = "red", guide = guide_legend(title = "ENI")) +xlab("") + ylab("")

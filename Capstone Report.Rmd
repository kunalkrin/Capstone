...
final2 <- kmeans(schoolPredict, 2, nstart = 25)
print(final2)
fviz_cluster(final2, data = schoolPredict)

#explains 52.9%% variability and surprisingly little overlap
...
#Bayes gives us a 73.8%% accuracy.
pred1<-predict(nbmodel, newdata = test)
table(pred1, test$tookFactor)


#Random Forest gives us a 82.7% accuracy.

...
ggmap(eniMap) +
  stat_summary_2d(geom = "tile",bins = 50, data=race, aes(x = long, y = lat, z = eni), alpha=0.5) +
...
eniMap <- get_map(location = "New York City", zoom= 11, maptype = "terrain", source="google")
ggmap(eniMap) +
  stat_summary_2d(geom = "tile",bins = 20, data=score, aes(x = long, y = lat, z = count), alpha=0.5) +
